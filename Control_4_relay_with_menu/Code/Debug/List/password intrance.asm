...
_0x0:
	...
	.DB  0x3A,0x20,0x0,0x43,0x6F,0x72,0x72,0x65
	.DB  0x63,0x74,0x0,0x46,0x75,0x63,0x6B,0x20
	.DB  0x6F,0x66,0x66,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 003A         PORTC=keypad_x[keypad_counter];
	MOV  R30,R17
	LDI  R31,0
	SUBI R30,LOW(-_keypad_x)
	SBCI R31,HIGH(-_keypad_x)
	LD   R30,Z
	OUT  0x15,R30
; 0000 003B 
